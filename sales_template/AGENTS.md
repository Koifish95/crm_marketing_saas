...
Platform map: `crm_saas_vault/Home.md`, `crm_saas_vault/Current-State.md`. C2A, C2B Slice A, and SI Sales B1 are Successful. SI Sales B2 is **code-shipped** (core owner QA passed; refinements shipped; not Successful until regression QA). Do not implement C2 (CP catalog), D1, Beauty, S7, Strategic Insights migration, browser e-sign, or CRM email unless an active work order says so.
