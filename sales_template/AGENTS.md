...
- Staff: `/login` → `/dashboard`, `/companies` (outbound first), `/leads` (inbound), `/contacts`, `/opportunities`, `/activities`, `/campaigns`, `/offers`, `/proposals`
