...
| SI Sales B1 (commercial + acquisition) | **Code-shipped** (2026-09-12). Owner acceptance **pending**. Not Successful. Not B2. Not C2. Return: [[wip/WO-2026-09-12-si-sales-b1-commercial-acquisition-return]] |
...
**Authorized work:** none. B1 is code-shipped pending Scott’s browser acceptance. B1 does **not** authorize B2 (proposals/PDF/e-sign), C2, Core promotion, D1, Beauty, S7, or SI migration. See [[Working-Agreement]] and [[Work-Order-Protocol]].
...
### Sales vertical (`sales_template/`) — C2A Successful; C2B Slice A Successful; B1 code-shipped
...
C2A owner-accepted 2026-09-11. Closeout: [[history/C2A_closeout]]. C2B owner-accepted 2026-09-12. Closeout: [[history/C2B_closeout]]. Slice A implementation return: [[history/WO-2026-09-11-si-sales-slice-a-return]]. B1 implementation return: [[wip/WO-2026-09-12-si-sales-b1-commercial-acquisition-return]] (leave in `wip/` until owner acceptance).
...
- C2 Sales vertical **plus** Control Plane product catalog (C2A local Sales app exists; C2B Slice A exists; B1 commercial/acquisition code-shipped pending acceptance; C2 is not those slices)
- SI Sales B2 (proposals, PDF, versioning, e-sign/portal, customer form builder) — B1 commercial/acquisition is code-shipped, not Successful
...
| SI Sales B1 code-shipped (not Successful) | [[SaaS-Decisions#2026-09-12 — SI Sales B1 is code-shipped]] |
