...
CRM Core
   ...
   ├── Sales / Software (C2A/C2B/B1 Successful; B2 code-shipped awaiting regression QA; sales_template, :5040; no CP catalog)
   └── Beauty           (not started)
```
