...
[[SaaS-Milestones]] **S2–S5** are Successful. S6 is implemented, not Successful until Scott’s pass. Boot steps: [[S2-Hand-Boot-Checklist]]. Observe: [[S3-Control-Plane-Runbook]]. Provision: [[S4-Provision-Runbook]]. D1 account/instance split is **not** implemented. Do not start C1 unless Scott asks.
