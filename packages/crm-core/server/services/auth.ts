...
export async function loadActiveUser(db: AppDatabase, id: number): Promise<SessionCookieUser | null> {
...
export async function bumpSessionVersion(db: AppDatabase, userId: number) {
